...
import { FaMotorcycle, FaCheck, FaRupeeSign, FaClock, FaUserTie, FaChartLine, FaShieldAlt, FaMobileAlt, FaBolt, FaBriefcase, } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="relative flex flex-col lg:flex-row min-h-[80vh] bg-gradient-to-br from-[#0F2027] via-[#203A43] to-[#2C5364] text-white">
        ...
        <div className="lg:w-1/2 p-12 flex flex-col justify-center">
          ...
          >
            ...
            >
              ...
              <span className="text-[#A47148] font-semibold tracking-wider">TWO WHEELER LOAN</span>
            </motion.div>
            ...
            <motion.h1 
              ...
              variants={fadeIn}
            >
              Ride Your Dream <span className="text-[#A47148]">Two-Wheeler</span> Today
            </motion.h1>
            ...
            <motion.p 
              ...
              variants={fadeIn}
            >
              Buying a new two wheeler is now easy with our bouquet of easily accessible two wheeler loans. 
              Embrace prosperity and progress with loans at attractive rates of interest and with flexible tenures.
            </motion.p>
            ...
            <motion.div className="flex flex-wrap gap-4" variants={fadeIn}>
              <button className="bg-[#A47148] hover:bg-[#8B5A2B] text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all flex items-center gap-2 group">
                Apply Now 
                <FaMotorcycle className="transition-transform group-hover:translate-x-1" />
              </button>
        ...
        <div className="lg:w-1/2 relative">
          <img 
            src="https://images.unsplash.com/photo-1558981806-ec527fa84c39?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80" 
            alt="Modern two wheeler"
          ...
          <div className="absolute bottom-8 left-8 bg-white p-6 rounded-xl shadow-lg max-w-xs">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-lg text-[#1D3557]">90% Funding</p>
                <p className="text-gray-500 text-sm">On two-wheeler value</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-[#1D3557] mb-6">
                <span className="text-[#A47148]">Overview</span> of Our Two Wheeler Loan
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                SK Finance Limited offers convenient and hassle-free loans for buying bikes or two-wheelers. 
                Our loans are a boon for everyone staying in rural or urban zones with the desire to purchase 
                their own two-wheelers.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                We not only offer low interest rates, but also flexible EMI choices. We understand how a 
                two-wheeler is synonymous with convenience, comfort and productivity in modern life. 
                With our funding solutions, you can own your dream two-wheeler without any hassles!
              </p>
      ...
      <section id="features-benefits" className="py-20 bg-gray-100">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              {
                icon: <FaMotorcycle className="text-3xl text-[#A47148]" />,
                title: "Pre-Owned or New",
                desc: "Loan options for both new and used two-wheelers"
              },
              {
                icon: <FaClock className="text-3xl text-[#A47148]" />,
                title: "Flexible Terms",
                desc: "Customizable loan tenure and EMI options"
              },
              {
                icon: <FaRupeeSign className="text-3xl text-[#A47148]" />,
                title: "Low Interest Rates",
                desc: "Competitive rates for affordable financing"
              },
              {
                icon: <FaShieldAlt className="text-3xl text-[#A47148]" />,
              ...
              },
              {
                ...
                desc: "Dedicated support throughout your loan journey"
              },
              {
              ...
              },
              {
                ...
                desc: "Quick approval and disbursement"
              },
              {
                icon: <FaChartLine className="text-3xl text-[#A47148]" />,
                title: "Improve Credit Score",
                desc: "Timely payments help build your credit history"
              }
            ].map((item, index) => (
              <motion.div 
                key={index}
      ...
      <section id="eligibility" className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We have simplified eligibility criteria for two wheeler loans.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: "Employment",
                items: ["1 year or more of employment/business"],
                icon: <FaBriefcase className="text-2xl text-[#A47148]" />
              },
              {
                title: "Age",
                items: ["Minimum 21 years", "Maximum 65 years at loan maturity"],
                icon: <FaUserTie className="text-2xl text-[#A47148]" />
              },
              {
                title: "Income",
                items: ["Stable income source", "Minimum income varies by location"],
